...
public class CarInsPlanKindChildBean {
    ...
    private InputValueBean inputValue;
    ...
    public InputValueBean getInputValue() {
        return inputValue;
    }

    public void setInputValue(InputValueBean inputValue) {
    ...
    public CarInsPlanKindChildBean() {
